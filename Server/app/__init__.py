...
# socketio = SocketIO(app,cors_allowed_origins="*"if os.environ.get('FLASK_ENV') != 'production' else "https://gatherlive.onrender.com:8000")
...
def react_root(path):
    ...
    if path == 'pick_server.PNG':
        return app.send_from_directory('public','pick_server.PNG')
